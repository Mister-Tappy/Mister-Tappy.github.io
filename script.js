...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const translations = {
        th: {
            ...
            experience9Year: '2569',
            experience9Activity: 'Introducing to Backend Developer',
            experience9Description: 'เรียนรู้เรียนการเป็น Backend Developer',
            experience10Year: '2569',
            experience10Activity: 'Ai Camp 2',
            experience10Description: 'เรียนรู้การใช้ AI ในการพัฒนาเกม',
            experience11Year: '2569',
            experience11Activity: 'GTC : Build Your Own',
            experience11Description: 'เรียนรู้การใช้ AI ในรูปแบบต่างๆ',
            ...
            activitySummaryText9: 'เป็นค่ายที่สอนเกี่ยวกับการเป็น Backend Developer ซึ่งเป็นทักษะที่สำคัญในการพัฒนาแอปพลิเคชันและเว็บไซต์ การเรียนรู้เหล่านี้จะช่วยให้ฉันสามารถสร้างระบบที่มีประสิทธิภาพและตอบสนองความต้องการของผู้ใช้ได้ดีขึ้นในอนาคต การสร้าง Server และ API เป็นส่วนสำคัญของการพัฒนาแอปพลิเคชันที่สามารถเชื่อมต่อกับฐานข้อมูลและให้บริการข้อมูลแก่ผู้ใช้ได้อย่างมีประสิทธิภาพ พร้อมกับการเรียนรู้ Node Js cors Express และ Insomania ซึ่งเป็นเครื่องมือที่นิยมใช้ในการพัฒนา Backend ทำให้ผมสามารถสร้างเว็บไซต์ที่มีความสามารถในการจัดการข้อมูลและตอบสนองต่อคำขอของผู้ใช้ได้อย่างรวดเร็วและมีประสิทธิภาพ ',
            activitySummaryText10: 'ค่ายนี้ได้ให้ความรู้เกี่ยวกับการสร้างเกมด้วย Unity และการทำงานร่วมกันในทีม ซึ่งเป็นทักษะที่สำคัญสำหรับการพัฒนาเกม การเรียนรู้เหล่านี้จะช่วยให้ฉันสามารถสร้างเกมที่มีประสิทธิภาพและตอบสนองความต้องการของผู้เล่นได้ดีขึ้นในอนาคตและยังมีการ prompt Ai ให้มีประสิทธิภาพมากขึ้นอีกด้วย ซึ่งเป็นทักษะที่สำคัญในการทำงานกับเทคโนโลยี AI ในปัจจุบันและอนาคต ซึ่งจะต้องทำผลงานภายใน 3 วันพร้อมกับที่เรียนรู้การพี่ๆในค่ายไปด้วย ',
        ...
        en: {
            ...
            experience9Year: '2026',
            experience9Activity: 'Introducing to Backend Developer',
            experience9Description: 'Learn to become a Backend Developer.',
            experience10Year: '2026',
            experience10Activity: 'Ai Camp 2',
            experience10Description: 'Learn to use AI in game development.',
            experience11Year: '2026',
            experience11Activity: 'GTC : Build Your Own',
            experience11Description: 'Learn to use AI in various ways.',
            ...
            activitySummaryText9: 'This camp taught me about backend development, a crucial skill for developing applications and websites. Learning these skills will help me create more efficient and responsive systems for users in the future. Building servers and APIs is a key part of developing applications that can connect to databases and efficiently provide data to users. Learning Node.js, Cors, Express, and Insomania, popular backend development tools, enabled me to create websites capable of managing data and responding to user requests quickly and efficiently.',
            activitySummaryText10: 'This camp provided knowledge about game development with Unity and teamwork, which are crucial skills for game development. These lessons will help me create more effective and responsive games for players in the future. It also taught me how to prompt AI more efficiently, a vital skill for working with AI technology now and in the future. We had to complete a project within three days while learning from the instructors at the camp.',
